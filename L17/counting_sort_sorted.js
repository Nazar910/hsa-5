...
const SORT_DATA_FILE = './results/counting_sort_sorted.dat';
...
searchStatsWriteStream.end('', () => execSync(`gnuplot -e 'set term png; set xlabel "Dataset size"; set ylabel "Time, nanosec"; set yrange [0:300000]; plot "${SORT_DATA_FILE}" with l' > ./results/counting_sort_sorted.png`));
